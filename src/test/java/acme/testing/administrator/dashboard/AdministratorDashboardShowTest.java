...
public class AdministratorDashboardShowTest extends AcmePlannerTest {
	...
	*/
	...
	public void showPositive(
		final String ratio1, final String ratio2, final String averageSheetsEUR, 
		final String averageSheetsUSD, final String deviationSheetsEUR, 
		final String deviationSheetsUSD,
		...
		super.checkErrorsAcmeMessageExist(2,1,5,deviationSheetsEUR.toString());
		super.checkErrorsAcmeMessageExist(2,1,6,deviationSheetsUSD.toString());

		super.checkErrorsAcmeMessageExist(2,1,7,nPrivateTask.toString());
		super.checkErrorsAcmeMessageExist(2,1,8,nPublicTask.toString());
		super.checkErrorsAcmeMessageExist(2,1,9,nFinishedTask.toString());
		super.checkErrorsAcmeMessageExist(2,1,10,nNotFinishedTask.toString());
